...
class _MyHomePageState extends State<MyHomePage>
{
  ...
  void _incrementCounter() {
    print('lol');
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => SytodyApp())
    );
  }
...
class SytodyAppState extends State<SytodyApp>
{
  ...
  List<CheckedPopupMenuItem<Language>> get _buildLanguagesWidgets =>
      languages.map((l) => new CheckedPopupMenuItem<Language>(
          value: l, checked: selectedLang == l, child: new Text(l.name)
      )).toList();
